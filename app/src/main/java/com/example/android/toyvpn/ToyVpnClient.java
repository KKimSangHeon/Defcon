...
public class ToyVpnClient extends Activity implements View.OnClickListener {
    ...
    public void onClick2(View v) {
        ...
        final Intent intent = new Intent(getApplicationContext(), DataCheckActivity.class);
    ...
    protected void onActivityResult(int request, int result, Intent data) {
        if (result == RESULT_OK) {
            ...
            startService(intent);
            final Intent intent2 = new Intent(getApplicationContext(), MainActivity2.class);
